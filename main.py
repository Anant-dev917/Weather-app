...
def getWeather():
    ...
    geolocator = Nominatim(user_agent="main")    #Enter your application name for 'user_agent' as an http request header to Nominatim
...
resized_panel = img.resize((260,130))
Round_box = ImageTk.PhotoImage(resized_panel)
Label(root,image=Round_box,bg="#57adff").place(x=5,y=110)

#label

label1=Label(root,text="Temperature",font=('Helvatica',10,"bold"),fg="white",bg="#203243")
label1.place(x=30,y=119)

label2=Label(root,text="Humidity",font=('Helvatica',10,"bold"),fg="white",bg="#203243")
label2.place(x=35,y=139)

label3=Label(root,text="Pressure",font=('Helvatica',10,"bold"),fg="white",bg="#203243")
label3.place(x=35,y=159)

label4=Label(root,text="Wind Speed",font=('Helvatica',10,"bold"),fg="white",bg="#203243")
label4.place(x=35,y=179)

label5=Label(root,text="Description",font=('Helvatica',10,"bold"),fg="white",bg="#203243")
label5.place(x=32,y=199)
...
resized_img = img.resize((260,136))
firstbox = ImageTk.PhotoImage(resized_img)
secondbox=PhotoImage(file="Images/Rounded Rectangle 2 copy.png")

Label(frame,image=firstbox,bg="#212120").place(x=25,y=20)
...
#clock
clock=Label(root,font=("Helvatica",20,'bold'),fg="white",bg="#57adff")
clock.place(x=30,y=20)


#timezone
timezone=Label(root,font=("Helvatica",20),fg="white",bg="#57adff")
timezone.place(x=600,y=20)


long_lat=Label(root,font=("Helvatica",10),fg="white",bg="#57adff")
...
secondimage.place(x=7,y=28)

day2temp=Label(secondframe,font="arial 8",bg="#282829",fg="#fff")
...
thirdimage.place(x=7,y=28)

day3temp=Label(thirdframe,font="arial 8",bg="#282829",fg="#fff")
...
fourthimage.place(x=7,y=28)

day4temp=Label(fourthframe,font="arial 8",bg="#282829",fg="#fff")
...
fifthimage.place(x=7,y=28)

day5temp=Label(fifthframe,font="arial 8",bg="#282829",fg="#fff")
...
sixthimage.place(x=7,y=28)

day6temp=Label(sixthframe,font="arial 8",bg="#282829",fg="#fff")
...
seventhimage.place(x=7,y=28)

day7temp=Label(seventhframe,font="arial 8",bg="#282829",fg="#fff")
